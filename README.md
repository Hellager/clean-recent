...
| `Boolean` | RemoveFromQuickAccess(`String` path) | removes given path from quick access | 
| `void` | ClearRecent() | clear the quick access | 
...
### ⚠️ `AddToQuickAccess` is not running properly!

You can run the tests to check, it's been temporarily commented out.

I have asked a question about it here [function SHAddToRecentDocs seems not working on win10 for folders](https://learn.microsoft.com/en-us/answers/questions/1115223/function-shaddtorecentdocs-seems-not-working-on-wi.html).

If you know how to solve it or any good ideas, please let me know to make it complete.
