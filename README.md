...
| `Dictionary<String, String>` | GetFrequentFolders() | Get the frequent folders in quick access in dictionary.  <br /> `<folder path, folder name>` |
| `Dictionary<String, String>` | GetRecentFiles() | Get the recent files in quick access in dictionary.  <br /> `<file path, file name>` |
